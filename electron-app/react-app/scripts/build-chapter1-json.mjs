...
const activities = [
  ...
  },
  {
    ...
    pages: [
      {
        id: 'fragen-1-2',
        type: 'reading_self_check',
        title: 'Fragen zum Text (1–2)',
        readingItems: [
          {
            id: 1,
            prompt:
              '1. Write down all the greetings for the three countries: which terms are used for greeting (Begrüßung) and taking leave (Verabschiedung)?',
            modelAnswer:
              "Deutschland — Begrüßung: e.g. Moin moin, Grüß Gott, Guten Morgen/Tag/Abend, Hallo, Hi, Servus. Verabschiedung: e.g. Tschüss, Tschö, Ade, Auf Wiedersehen, Mach's gut, Ciao.\n\nÖsterreich — Begrüßung: e.g. Servus, Grüß dich, Grüß Gott. Verabschiedung: e.g. Tschüss, Auf Wiedersehen, Mach's gut, Ciao.\n\ndie Schweiz — Begrüßung: e.g. Grüezi, Guten Tag. Verabschiedung: e.g. Auf Wiedersehen, Tschüss."
          },
          {
            id: 2,
            prompt: '2. According to the text, which greetings are formal and which are informal?',
            modelAnswer:
              "Formal: e.g. Guten Morgen/Tag/Abend, Grüezi (formal register), addressing strangers with Sie. Informal: Moin moin, Hallo, Hi, Servus among friends; Tschüss, Mach's gut, Ciao among friends."
          }
        ]
      },
      {
        id: 'fragen-3-4',
        type: 'reading_self_check',
        title: 'Fragen zum Text (3–4)',
        readingItems: [
          {
            id: 3,
            prompt:
              '3. How do you understand „duzen“ and „siezen“ based on this text? With whom would you use each? Is there a similar distinction in formality in your own language?',
            modelAnswer:
              'Duzen is using informal du with good friends and family; siezen is using formal Sie with strangers or people you do not know well. Answers about your own language will vary (e.g. tu/vous, tú/usted, first name vs. title).',
            keywords: ['du', 'sie', 'duzen|siezen', 'formal|friend|freund|famil|language|sprache']
          },
          {
            id: 4,
            prompt:
              '4. Do you have German-speaking family or friends? If yes, what greetings do they use with various people?',
            modelAnswer: 'Answers will vary based on your interviews.'
          }
        ]
      }
    ],
    ...
    pdfNote: 'COERLL Kapitel 1 workbook, p. 42.'
  },
  {
    chapter: 1,
    id: 33,
